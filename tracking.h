...
#define PAN_TARGET_PIXEL_DEFAULT 127  //79 default, 100 for shipunit, 125 for other
#define TILT_TARGET_PIXEL_DEFAULT 119  //119
...
#define PAN_SEARCH_STEP_SIZE_DEFAULT 31
...
#define PAN_CENTER_PWM_DEFAULT 124  //124
#define TILT_CENTER_PWM_DEFAULT 144   //144

// These values define the lower and upper bound on the
// tilt servo travel
#define TILT_MIN_PWM_DEFAULT 144  // 0 degrees, (-31deg =88)
#define TILT_MAX_PWM_DEFAULT 190 // +31 degrees, (+31deg = 200)
...
#define TILT_SEARCH_STEP_SIZE_DEFAULT 24
